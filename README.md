...
For the conceptual generalization path from rectangular mazes to topology-owned structure, see [docs/from-rectangular-to-topology.md](docs/from-rectangular-to-topology.md).
